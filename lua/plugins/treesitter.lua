...
vim.api.nvim_set_hl(0, "TSKeywordFunction",     { bg = "NONE", fg = "#9D7CD8", italic = true })
vim.api.nvim_set_hl(0, "TSKeywordOperator",     { bg = "NONE", fg = "#C53B82", })
vim.api.nvim_set_hl(0, "TSKeywordReturn",       { bg = "NONE", fg = "#C53B82", bold = true, italic = true })
...
vim.api.nvim_set_hl(0, "TSMethod",              { bg = "NONE", fg = "#9D7CD8", italic = true })
vim.api.nvim_set_hl(0, "TSNamespace",           { bg = "NONE", fg = "#C53B82", bold = true, italic = true })
